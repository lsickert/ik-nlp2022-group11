...
Original file is located at
    https://colab.research.google.com/drive/1ni_9XL3w458-n3tPSffSMhryNXv3sZul

## BART MODEL

---

This notebook was used as a first experiment in loading the data and generating the SNLI labels and explanations using the Facebook BART model (https://huggingface.co/facebook/bart-large)

Mostly used to see how easy it is to obtain scores for this tasks and to identify some possible blockers.
"""
